...
?>
    ...
    <p>Social-Network ("us", "we", or "our") uses cookies on the www.social-network.com website (the "Service"). By using the Service, you consent to the use of cookies.</p>
    ...
    <h2>How Social-Network uses cookies</h2>
    <hr>
